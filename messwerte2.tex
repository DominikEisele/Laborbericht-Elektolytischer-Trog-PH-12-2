\begin{tikzpicture}[xscale=1.2,yscale=1.2]
		...
		% 6V	
			\node[red]  (25) at (10.6,9.00) {\textsf{+}};
			\node[red]  (25) at (9.50,8.00) {\textsf{+}};
			\node[red]  (45) at (8.60,7.00) {\textsf{+}};
			\node[red]  (65) at (8.10,6.00) {\textsf{+}};
			\node[red]  (85) at (7.70,5.00) {\textsf{+}};
			\node[red] (105) at (7.60,4.00) {\textsf{+}};
			\node[red] (125) at (7.50,3.00) {\textsf{+}};
			\node[red] (145) at (7.40,2.00) {\textsf{+}};
			\node[red] (165) at (7.50,1.00) {\textsf{+}};
			\node[red] (185) at (7.40,0.00) {\textsf{+}};
			

			\node[red] (205) at (10.7,-7.00) {\textsf{+}};
			\node[red] (225) at (8.50,-6.00) {\textsf{+}};
			\node[red] (245) at (8.40,-5.00) {\textsf{+}};
			\node[red] (265) at (8.00,-4.00) {\textsf{+}};
			\node[red] (285) at (7.70,-3.00) {\textsf{+}};
			\node[red] (305) at (7.60,-2.00) {\textsf{+}};
			\node[red] (325) at (7.40,-1.00) {\textsf{+}};


			\draw [red] plot [smooth] coordinates {(10.6,9) (8.6,7) (8.1,6) (7.6,4) (7.5,0) (7.6,-4) (9,-6.5) (11,-7.5)};
		...
		% Feldlinien
			\draw[thick ,taupe] plot [smooth] coordinates {(0,3.65) (1,3.875) (2,4.1) (3,4.3) (4,4.4) (5,4.4) (6,4.4) (7,4.35) (8,4.25) (9,4.1) (10,3.875) (11,3.65)};
			\draw[thick ,taupe] plot [smooth] coordinates {(0,5-0.3) (1,5.6-0.3) (2,6.3-0.3) (3,6.8-0.3) (4,7.15-0.3) (5,7.2-0.3) (6,7.2-0.3) (7,7.15-0.3) (8,6.8-0.3) (9,6.3-0.3) (10,5.6-0.3) (11,5-0.3)};
			\draw[- ,thick ,taupe] (0,1.35) -- (11,1.35);
			\draw[- ,thick ,taupe] (0,-2.85) -- (11,-2.85);
			\draw[- ,thick ,taupe] (0,-2.05) -- (11,-2.05);
			\draw[- ,thick ,taupe] (0,2.05) -- (11,2.05);

		% Punkte für elektr. Feldstärke E
			\node (1) at (1.3,5.5) {\textsf{x}} node[below right] {$P_1$};
			\node (2) at (6.2,1,35) {\textsf{x}} node[below right] {$P_1$};
			\node (3) at (7.38,-2,05) {\textsf{x}} node[below right] {$P_2$};
